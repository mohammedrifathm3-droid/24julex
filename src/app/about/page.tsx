...
export default function AboutPage() {
  ...
  const stats = [
    ...
    { number: '200K+', label: 'Products Sold', icon: Heart },
    { number: '5+', label: 'Years in Business', icon: Award },
    { number: '500+', label: 'Cities Delivered', icon: MapPin }
  ]
